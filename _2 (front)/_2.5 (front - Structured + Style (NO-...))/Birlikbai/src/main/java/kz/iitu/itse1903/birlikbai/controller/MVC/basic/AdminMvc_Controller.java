...
public class AdminMvc_Controller {
    ...
    @Autowired
    public AdminMvc_Controller(AdminService adminService, BusService busService, DriverService driverService, ScheduleService scheduleService, BookingService bookingService) {
